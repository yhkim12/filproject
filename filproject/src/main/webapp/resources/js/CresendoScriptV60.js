...
function FN_GetCookie(_Ec) {
	var _RT = document.cookie.match ( '(^|;) ?' + _Ec + '=([^;]*)(;|$)' );
	if ( _RT) { return unescape(_RT[2]); } else { return ""; }
}
